...
4. 创建 assertion.io.github.xiaomisum.ryze.core.Assertion
5. 在 assertion.io.github.xiaomisum.ryze.core.Assertion 文件中填写 自定义验证器的完整类名（含包路径）

参考[示例](../../migoo-core/src/main/resources/META-INF/services/testelement.io.github.xiaomisum.ryze.core.TestElement)
...
2. 在 META-INF 目录中创建目录 services
3. 在 services 目录中创建文件
4. 创建 assertion.io.github.xiaomisum.ryze.core.Rule
5. 在 assertion.io.github.xiaomisum.ryze.core.Rule 文件中填写 自定义验证规则的完整类名（含包路径）

参考[示例](../../migoo-core/src/main/resources/META-INF/services/assertion.io.github.xiaomisum.ryze.core.Rule)
